...
const MechanicRegister= () => {
  ...
  let url = name === "user" ? "register/" : "mechanic_register/";
    ...
    try {
      ...
      if (emailCheckResponse.status === 200) {
        ...
        if (response.status === 201) {
          ...
          navigate('/otp/', { state: { formData: userData, otp, url } });
        } else {
    ...
    <>
      ...
      <div style={{ marginTop: "10rem" }}>
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto mt-5 bg-white p-4">
          <h2 className="text-2xl font-semibold text-center mb-6">Mechanic Register</h2>
          ...
          <Typography color="gray" className="mt-4 text-center font-normal">
            ...
            <a href="#" onClick={handleSignin} className="font-medium text-gray-900">
              Sign In
            </a>
          </Typography>
        </form>
