...
GetLastMessages()
  ...
  return (
<li className="p-2 m-2 mt-3 border-bottom" onClick={handlechat} style={selectedChat === props.name ? {backgroundColor: 'grey',color:"white",fontWeight:"bold" ,borderRadius:"15px"} : {borderRadius:"15px",backgroundColor:"rgb(33, 35, 35)"}}>
